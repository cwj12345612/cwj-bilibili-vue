<template>
    <div class="video_header">
        <div class="all">
            <ul class="title">
                <span class="active">全部稿件 {{ mock('@integer(10,2000)') }}</span>
                <span>草稿箱</span>
            </ul>
            <ul class="items">
                <li>进行中</li>
        ...
        <div class="filter">
            ...
            <select class="other">
                <option>按投稿时间排序</option>
                <option>按播放次数排序</option>
                <option>按收藏人数排序</option>
                <option>按弹幕条数排序</option>
            </select>
        </div>
    </div>
    <ul class="videos">
            ...
            <div class="desc">
                ...
                <div class="sys">
                    <div class="d">
                        ...
                        <div class="zimu">当前字幕: 1 (含自动生成)</div>
                    </div>
                    <div class="setting">
                        <button>
                            ...
                            编辑</button>
                        <button>
                            <i class="colourless _ico_backtokb"></i>
                            数据</button>
                        <button>
...
.video_header .all .title {
    display: flex;
}

.video_header .all .title span {
    margin-right: 20px;
    cursor: pointer;
}

.video_header .all .title span.active {
    color: #0aaee0;
}

.video_header .all .items {
    display: flex;
...
.videos li .desc .other{
    display: flex;
    align-items: center;
    justify-content: flex-start;
}
.videos li .desc .other span{
    color: #99a299;
    margin-right: 15px;
}
.page{
